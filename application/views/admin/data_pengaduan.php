          ...
          <div class="card shadow mb-2">
            <div class="card-header py-3">
              ...
              <div class="float-right">
                    <a href="<?= base_url('admin/print_data_pengaduan'); ?>" target="_blank" class="btn btn-sm btn-secondary shadow-sm"><i class="fas fa-print fa-sm text-white-50"></i> Print</a>
                </div>
            </div>
            <div class="card-body">
                    ...
                    <tr>
                      ...
                      <td align="center">
                        ...
                        <?php } elseif($row['status']=="Selesai"){ ?>
                            <a href="<?= base_url('admin/detail/'.$row['id_pengaduan']); ?>" class="btn btn-info btn-sm">Selesai</a>
                          <?php }else{
                            echo $row["status"]; 
                          }
                          ?>
