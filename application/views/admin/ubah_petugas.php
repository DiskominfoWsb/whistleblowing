<div class="container">
    ...
    <hr/>
    <a href="<?= base_url('admin/data_petugas'); ?>" class="btn btn-sm btn-warning mb-3"><i class="fas fa-arrow-circle-left fa-md text-white-50"></i> Batal</a>
        <div class="col-lg-12">
                        ...
                        <div class="col-lg-12">
                            <div class="p-5">
                                ...
                                <form method="post" action="<?= base_url('admin/ubah_petugas'); ?>">
                                    ...
                                    <div class="form-group ">
                                        <input type="number" class="form-control form-control-user" id="telp" name="telp" value="<?= $petugas['telp']; ?>">
