          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
                <div class="float-left">
                    <a href="<?= base_url('masyarakat/data_aduanselesai'); ?>" class="btn btn-sm btn-danger shadow-sm"><i class="fas fa-arrow-circle-left fa-md text-white-50"></i> Kembali</a>
                </div>
                <div class="float-right">
                    <a href="<?= base_url('masyarakat/print_tanggapan/'.$detail['id_pengaduan']); ?>" class="btn btn-sm btn-secondary shadow-sm" target="_blank"><i class="fas fa-print fa-sm text-white-50"></i> Print</a>
                </div>
            </div>
            <div class="card-body">
              <div class="row">
