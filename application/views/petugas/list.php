          ...
          <div class="card shadow mb-2">
            <div class="card-header py-3">
                <div class="float-left">
                    <a href="<?= base_url('petugas'); ?>" class="btn btn-sm btn-danger shadow-sm"><i class="fas fa-arrow-circle-left fa-sm text-white-50"></i> Kembali</a>
                </div>
            </div>
            <div class="card-body">
                    ...
                    <tr>
                      ...
                      <td align="center">
                        ...
                        <?php } else if ($row['status']=="Selesai"){ ?>
                          <a href="<?= base_url('petugas/detail/'.$row['id_pengaduan']); ?>" class="btn btn-info btn-sm" title="Lihat Detail Tanggapan"> Selesai</a>
