...
class Auth extends CI_Controller
{
	...
	private function _sendEmail($token, $type)
	{
		$config = [
			...
			'smtp_user' => 'whistleblowing.pemkabwonosobo@gmail.com',
			'smtp_pass' => 'w1$thL38LOVv!Ng.Wsb35',
			'smtp_port' => 465,
			'mailtype'  => 'html',
			'charset'   => 'utf-8',
			'newline'   => "\r\n"
		...
		$this->email->from('whistleblowing.pemkabwonosobo@gmail.com', 'Whistleblowing Pemerintah Kabupaten Wonosobo');
